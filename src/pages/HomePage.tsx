...
const anniversaryYear = new Date().getFullYear() - 2019;
const anniversaryYearLastDigit =
  anniversaryYear.toString().length > 1
    ? +`${anniversaryYear}`.split("")[`${anniversaryYear}`.length - 1]
    : anniversaryYear;
const anniversaryYearSymbol =
  anniversaryYearLastDigit === 1
    ? "st"
    : anniversaryYearLastDigit === 2
      ? "nd"
      : anniversaryYearLastDigit === 3
        ? "rd"
        : "th";
      ...
      <SiteChrome>
        ...
        >
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <h3 className="text-[18px] font-bold uppercase tracking-[1px] opacity-80">
                  Established 2019
                </h3>
                <span className="bg-js-black text-js-yellow text-[10px] font-black px-2 py-0.5 rounded-full animate-pulse">
                  {anniversaryYear}
                  {anniversaryYearSymbol.toUpperCase()} ANNIVERSARY
                </span>
              </div>
              <h2 className="text-3xl sm:text-4xl md:text-[56px] font-extrabold leading-[0.95] tracking-tight sm:tracking-[-2px] uppercase">
                {anniversaryYear} YEARS OF BUILDING THE ECOSYSTEM.
              </h2>
            </div>
            <div className="flex flex-col gap-4">
              <p className="text-sm font-medium max-w-xs opacity-90 leading-relaxed">
                From a small gathering in a cafe to Uganda's premier tech
                community. We write the future, one line of JavaScript at a
                time.
              </p>
              <button
          ...
          >
            <div className="w-full sm:max-w-[70%] min-w-0">
              <h3 className="text-js-yellow font-black text-xl sm:text-2xl uppercase tracking-tighter mb-2">
                Get Your Tickets
              </h3>
              <p className="text-sm opacity-70">
                All JavaScript Kampala events are officially published on
                TicketDaddy. Secure your spot now.
              </p>
            </div>
          ...
          >
            <h3 className="text-[14px] font-bold uppercase tracking-[1px] opacity-60">
              Next Meetup
            </h3>
            <div>
          ...
          >
            ...
            <div className="overflow-hidden">
              <span className="stat-number text-js-yellow block truncate">
                5.7K+
              </span>
              <p className="text-[10px] md:text-xs uppercase tracking-widest opacity-60 mt-1">
          ...
          >
            ...
            <p className="text-sm opacity-80 leading-relaxed">
              To foster a vibrant, inclusive environment where developers in
              Kampala can learn, share, and collaborate on cutting-edge web
              technologies. We are the home for JavaScript enthusiasts.
            </p>
          </motion.div>
          ...
          >
            <Calendar
              className="text-js-yellow group-hover:scale-110 transition-transform"
              size={24}
            />
            <div>
              <h3 className="text-[14px] font-bold uppercase tracking-[1px]">
                Events
              </h3>
              <p className="text-[10px] opacity-40 uppercase tracking-tighter mt-1">
                Tickets via TicketDaddy
              </p>
            </div>
          </motion.a>
        ...
        <section id="sponsors" className="mt-24">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 mb-12">
            ...
            <Heart
              className="text-js-yellow w-7 h-7 md:w-8 md:h-8 shrink-0 order-3 sm:order-none"
              strokeWidth={2}
            />
          </div>
        ...
        <section id="community" className="mt-24">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 mb-12">
            ...
            <div className="h-[2px] flex-grow bg-white/10 min-w-0 order-2 sm:order-none" />
            <Users
              className="text-js-yellow w-9 h-9 md:w-10 md:h-12 shrink-0 order-3 sm:order-none"
              strokeWidth={2}
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-js-dark border border-white/5">
              <h4 className="text-js-yellow font-bold uppercase mb-4 tracking-widest">
                Mentorship
              </h4>
              <p className="text-sm opacity-60 leading-relaxed">
                Connect with senior developers who can guide you through your
                career journey in the tech ecosystem.
              </p>
            </div>
            <div className="p-8 bg-js-dark border border-white/5">
              <h4 className="text-js-yellow font-bold uppercase mb-4 tracking-widest">
              ...
              <p className="text-sm opacity-60 leading-relaxed">
                Regular meetups designed to help you meet peers, find
                co-founders, or discover your next job opportunity.
              </p>
            </div>
            <div className="p-8 bg-js-dark border border-white/5">
              <h4 className="text-js-yellow font-bold uppercase mb-4 tracking-widest">
              ...
              <p className="text-sm opacity-60 leading-relaxed">
                Hands-on sessions covering everything from React and Node.js to
        ...
        <section id="speakers" className="mt-24">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 mb-12">
            ...
            />
            <div className="h-[2px] flex-grow bg-white/10 min-w-0 order-2 sm:order-none" />
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black uppercase tracking-tighter order-1 sm:order-none">
              Speakers
            </h2>
          </div>
            ...
            {SPEAKERS.map((speaker) =>
              speaker.kind === "cta" ? (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <Twitter
                      className="text-js-yellow mb-2 opacity-90"
                      size={18}
                    />
                    <h4 className="font-bold uppercase tracking-tighter text-lg">
                      {speaker.name}
        ...
        <footer className="mt-24 pt-8 border-t border-[#333] flex flex-col md:flex-row justify-between items-center gap-6 text-[12px] text-js-gray pb-12 text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-js-yellow transition-colors"
              aria-label="Twitter"
            >
              <Twitter size={16} />
            </a>
